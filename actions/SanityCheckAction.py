...
class SanityCheckAction(BaseAction):
    ...
    def send_sanity_check(self, description, state_event_table, parallel_state_table, transitions_table, max_retries=5):
        """
        ...
        prompt = f"""
                      You are an AI assistant specialized in creating UML state machines. You will be provided with a system description. Additionally, you will be provided with a table containing states and events, a table containing parallel states, and a table containing transitions of a UML State Machine.
    ...
    def execute(self, description):
        ...
        transitions_table = self.belief.get("transitions_guards_search_action")


        system_description_sentences = description.split(".")
