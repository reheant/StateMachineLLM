...
class EventDrivenAssociateEventsWithStatesAction(SMFAction):
    """
    ...
    def associate_events_with_states(self, system_name, state, events_table, max_retries=5):
        ...
        # max retries met
        self.log(f"Max retries reached. No relevant events found for state {state}.")
        return None
