...
class EventDrivenHistoryStateSearchAction(SMFAction):
    ...
    def execute(self):
        ...
        superstates = [state for state in gsm_tables_to_dict(self.belief.get('event_driven_create_hierarchical_states_action'), None, None, nesting = False)[0] if isinstance(state, dict)]
